// lib/screens/popular_posts_screen.dart
...
class _PopularPostsScreenState extends State<PopularPostsScreen> {
  // --- STATE DEĞİŞKENLERİ ---
  Future<List<Post>>? _popularPostsFuture;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "Popüler Yazılar"),
      body: FutureBuilder<List<Post>>(
        ...
        builder: (context, snapshot) {
          ...
          // --- DEĞİŞİKLİK: BUILD METODU ARTIK DOĞRUDAN WIDGET DÖNDÜRÜYOR ---
          ...
          if (snapshot.hasError) {
            return _buildErrorState(context); // Artık parametre almasına gerek yok
          }
  ...
  /// --- YENİ: ANA SAYFA İLE AYNI HATA EKRANI ---
  ...
  /// --- YENİ: İÇERİK OLUŞTURMA FONKSİYONU ---
